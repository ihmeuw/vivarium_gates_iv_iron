...
class __Population(NamedTuple):
    ...
    PLW_LOCATION_WEIGHTS: str = "population.pregnant_and_lactating_women_location_weights"
    WRA_LOCATION_WEIGHTS: str = "population.women_of_reproductive_age_location_weights"
