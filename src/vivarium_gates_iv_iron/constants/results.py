...
PREGNANCY_OUTCOME_COUNT_COLUMN_TEMPLATE = "outcome_{PREGNANCY_OUTCOME}_{ANEMIA_LEVEL_STR}_anemia_count_year_{YEAR}_age_{AGE_GROUP}"
...
TEMPLATE_FIELD_MAP = {
    ...
    "ANEMIA_LEVEL_STR": models.ANEMIA_LEVELS,
